...
| **Risk** | Medium — incorrect enrollment checks across a service boundary could allow invalid records |
...
These questions are exactly what Chapter 5 asks you to resolve before drawing service boundaries.
